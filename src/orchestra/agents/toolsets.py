...
def data_retrieval_tools(data_dir: Path) -> tuple[BaseTool, ...]:
    ...
    authoritative and narrow, `search` is contextual and offline — and choosing between
    them is the judgement the agent exists to make.
    ...
    return (
        ...
        SearchTool(data_dir / SEARCH_CORPUS),
    )
